...
1. Babel <script type='text/babel'\> will set it to compile jsx into js in real time.
2. Interpolate = add a different type of something inside another thing
    E.g: interpolate string = `${var} + banana` -> 'eat banana'
