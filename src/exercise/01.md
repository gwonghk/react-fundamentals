...
1. setAttribute vs direclty assign
  - Use node.setAttribute for non-standard attributes
  - for example aria attributes
  - in general setAttribute seems safer
2. append vs appendChild
  - appendChild only allows one node obj
    - //parent.append('hello world') is ok
  - append accepts domstrings and node objs
